...
```bash
pip install KNICS_Jupyter_frontend
```
...
```bash
pip uninstall KNICS_Jupyter_frontend
```
...
folder is located. Then you can remove the symlink named `KNICS_Jupyter_frontend` within that folder.
